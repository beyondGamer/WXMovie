...
//    [UIView transitionWithView:self.view   //切换的页面
//                      duration:.5          //动画的时长
//                       options:UIViewAnimationOptionTransitionFlipFromRight           //动画的效果
//                    animations:^{
//                        
//                        [self.view exchangeSubviewAtIndex:0 withSubviewAtIndex:1];//切换的动作
//                    }
