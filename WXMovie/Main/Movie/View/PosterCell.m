...
-(void)_createView{
    //我们collection属性没有间隙，并且翻转后的视图的大小也是前面这张图片同等大小，做法：缩小父视图
//    self.contentView = CGAffineTransformMakeScale(0.95, 0.95);
//    self.contentView.backgroundColor = [UIColor greenColor];
    ...
    //2.电影详情页面
    _detailView = [[[NSBundle mainBundle]loadNibNamed:@"MovievDetail" owner:self options:nil]lastObject];
    
    _detailView.frame = CGRectMake(0, 0, self.bounds.size.width * 0.95, self.bounds.size.height * 0.95);
